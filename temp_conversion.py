...
def convert_100_to_celsius():
    ...
    # I know that the resulting number is a float because it is a number
    # containing one or more decimals.
    # Also, when you run 'type(celsius_100)' it returns '<class "float">'
